          ...
          <div className="flex-1">
            <div className="w-full bg-zinc-950 aspect-video">
              <ReactPlayer
                ...
                height="100%"
                controls
                url="https://youtu.be/sBalrWc38fE"
              />
            </div>
          </div>
          <aside className="absolute divide-y-2 divide-zinc-900 overflow-y-scroll scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-zinc-950 top-0 bottom-0 right-0 w-80 border-l border-zinc-800 bg-zinc-900">
            <div>
              <button className="flex w-full items-center gap-3 bg-zinc-800 p-4">
                ...
                <div className="flex flex-col gap-1 text-left">
                  <strong className="text-sm">Unraveling Redux</strong>
                  <span className="text-xs  text-zinc-400">12 lessons</span>
                </div>
            ...
            <div>
              ...
              <nav className="relative flex flex-col gap-4 p-6">
                <button className="flex items-center gap-3 text-sm text-zinc-400 border-zinc-800 border-b-[1px] pb-2">
